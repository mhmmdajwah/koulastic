                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                     <img class="text-center" style="height: 150px; width: 150px; margin-left: 120px;  " src="{{ asset('img/logo koulastic.png') }}"
               alt="Logo">
                                    <h3 class="text-center font-weight-light my-(-10)">Login</h3>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('login.progress') }}" method="POST">
                                        @csrf
                                        @if (session('status'))
                                            <div class="alert alert-danger alert-dismissible text-white fade show mt-3"
                                                role="alert">
                                                {{ session('status') }}
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button class="btn btn-success col-12" href="index.html">Login</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
